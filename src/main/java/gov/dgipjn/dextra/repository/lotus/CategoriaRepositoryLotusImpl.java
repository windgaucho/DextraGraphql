...
import gov.dgipjn.dextra.repository.CategoriaRepository;

public class CategoriaRepositoryLotusImpl implements CategoriaRepository {
    @java.lang.Override
        ...
        try {
            ...
            NotesGC.runWithAutoGC(new Callable<Object>() {
                ...
                public Object call() throws Exception {
                    ...
                    NotesCollection view = dbData.openCollectionByName("vstCategorias");
                    ...
                    for (NotesViewEntryData currEntry : viewEntries) {
                        ...
                        c.setId(currEntry.getUNID());
                        c.setNombre((String) currEntry.get("txtCategoria"));
                        categorias.add(c);
